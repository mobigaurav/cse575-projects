...
def geneData(id):
    ...
    Numpyfile0 = scipy.io.loadmat('mat_files_pt_1/train_0_img.mat')
    Numpyfile1 = scipy.io.loadmat('mat_files_pt_1/train_1_img.mat')
    ...
    Numpyfile2 = scipy.io.loadmat('mat_files_pt_1/test_0_img.mat')
    Numpyfile3 = scipy.io.loadmat('mat_files_pt_1/test_1_img.mat')
