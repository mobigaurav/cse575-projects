...
# # Initialize centroids for both k values
# k1, init_s1, k2, init_s2 = initial_S1(id)
# print(f"For k={k1}, init_s1={init_s1}, k2={k2}, init_s2={init_s2}")
# # Run K-means for k1
# centroids1, labels1, loss1 = kmeans(data, k1, init_s1)
# print(f"For k={k1}, Loss={loss1}, Centroids={centroids1}")

# # Run K-means for k2
# centroids2, labels2, loss2 = kmeans(data, k2, init_s2)
# print(f"For k={k2}, Loss={loss2}, Centroids={centroids2}")
